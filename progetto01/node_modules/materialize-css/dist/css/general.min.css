...
main .sect {
  ...
  background-size: cover;
  position: relative;
  box-shadow: 1px 1px 5px 1px rgb(71, 71, 71);
...
main .sect-tit .sect-link h5 {
  font-weight: 700;
}
main .sect-tit .sect-link h5 a {
  color: #171717;
  text-decoration: underline;
}
main .sect-tit .sect-link:hover {
  background-color: #F9F9F9;
}
...
footer .back-to-top a {
  box-shadow: 0px 0px 5px 1px rgba(0, 0, 0, 0.6392156863);
}
...
.no-slider {
  box-shadow: 2px 2px 9px rgba(0, 0, 0, 0.3803921569);
